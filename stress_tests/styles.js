...
export default function productIdStressTest() {
  const res = http.get('http://localhost:3000/products/1000000/styles')
  sleep(1);

  const checkRes = check(res, {
    '/products/1000000/styles - status is 200': (r) => r.status === 200,
    // '/products/1000000/styles - response body exists': (r) => r.body.length !== 0,
  });
}
